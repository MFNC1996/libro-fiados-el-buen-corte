...
v.e_monto.poner("123456789012")
check("ni un numero larguisimo", v.e_monto.valor() == "")
...
v.e_detalle.poner("x" * 200)
check("el detalle tiene largo maximo", len(v.e_detalle.valor()) == 0)
v.e_detalle.poner("x" * 80)
check("80 letras si caben", len(v.e_detalle.valor()) == 80)
v.e_monto.limpiar()
